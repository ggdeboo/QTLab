...
v_dac.append('dac2')
v_vec.append(arange(0,350.1,0.2))

# From here on it will be static dacs
v_dac.append('dac1')
v_vec.append([-0.45]) # -0.45 results in 0.1 mV on sample, -0.35 is 0.23mV on sample

# Create ramp vector for the magnetic field
b_vec=arange(10,-0.2,-0.5)
...
data = qt.Data(name='QKD23MCI07ND7_IVgTrace_vs_B_Vb100uV_3748mK')
