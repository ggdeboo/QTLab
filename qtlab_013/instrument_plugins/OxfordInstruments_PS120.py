...
class OxfordInstruments_PS120(Instrument):
    '''
    This is the python driver for the Oxford Instruments PS 120-10 Magnet Power Supply

    Usage:
    Initialize with
    <name> = instruments.create('name', 'OxfordInstruments_PS120-10', address='<Instrument address>')
...
#TODO: get doesn't always update the wrapper! (e.g. when input is an int and output is a string)
    ...
    def __init__(self, name, address):
        '''
        Initializes the Oxford Instruments PS 120-10 Magnet Power Supply.
...
#        self._visainstrument.write('@%s%s' % (self._number, message))
    ...
    def identify(self):
        ...
        Output:
            None
        '''
        logging.debug(__name__ + ' : Identify the device')
    ...
    def examine(self):
        ...
        Output:
            None
        '''
        logging.debug(__name__ + ' : Examine status')
    ...
    def remote(self):
        ...
        Output:
            None
        '''
        logging.debug(__name__ + ' : Set control to remote & locked')
    ...
    def local(self):
        ...
        Output:
            None
        '''
        logging.debug(__name__ + ' : Set control to local & locked')
    ...
    def do_get_remote_status(self):
        ...
        Output:
            ...
            "Auto-run-down"
        '''
        logging.debug(__name__ + ' : Get remote control status')
    ...
    def do_set_remote_status(self, mode):
        ...
        if status.__contains__(mode):
            logging.debug(__name__ + ' : Setting remote control status to %s' % status.get(mode,"Unknown"))
    ...
    def do_get_system_status(self):
        ...
        '''
        result = self._execute('X')
        logging.debug(__name__ + ' : Getting system status')
        return int(result[1])
    ...
    def do_get_voltage(self):
        ...
        '''
        logging.debug(__name__ + ' : Read output voltage')
    ...
    def do_get_magnet_current(self):
        ...
        '''
        logging.debug(__name__ + ' : Read measured magnet current')
    ...
    def do_get_current_setpoint(self):
        ...
        '''
        logging.debug(__name__ + ' : Read set point (target current)')
        result = self._execute('R5')
        return int(result.replace('R',''))/100.0
    ...
    def do_set_current_setpoint(self, current):
        ...
        self._execute('I%i' % (100*round(current,2)))	#rounding added by Joost
    ...
    def do_set_sweeprate_current(self, sweeprate):
        ...
        self._execute('S%i' % (100*round(sweeprate,2)))	#rounding added by Joost
    ...
    def do_get_field(self):
        ...
        '''
        logging.debug(__name__ + ' : Read output field')
    ...
    def do_get_field_setpoint(self):
        ...
        '''
        logging.debug(__name__ + ' : Read field set point')
    ...
    def do_set_field_setpoint(self, field):
        ...
        Output:
            None
        '''
        logging.debug(__name__ + ' : Setting target field to %s' % field)
        self._execute('J%i' % (1000*round(field,3)))	#rounding added by Joost
    ...
    def do_get_sweeprate_field(self):
        ...
        '''
        logging.debug(__name__ + ' : Read sweep rate (field)')
    ...
    def do_set_sweeprate_field(self, sweeprate):
        ...
        Output:
            None
        '''
        logging.debug(__name__ + ' : Set sweep rate (field) to %s Tesla/min' % sweeprate)
        self._execute('T%i' % (1000*round(sweeprate,4)))	#rounding added by Joost
    ...
    def do_get_voltage_limit(self):
        ...
        '''
        logging.debug(__name__ + ' : Read voltage limit')
    ...
    def do_get_trip_current(self):
        ...
        '''
        logging.debug(__name__ + ' : Read trip current')
    ...
    def do_get_persistent_field(self):
        ...
        '''
        logging.debug(__name__ + ' : Read persistent magnet field')
    ...
    def do_get_switch_heater(self):
        ...
        '''
        logging.debug(__name__ + ' : Get switch heater status')
        result = self._execute('X')
        return int(result[8])
    ...
    def do_set_switch_heater(self, mode):
        ...
        if status.__contains__(mode):
            logging.debug(__name__ + ' : Setting switch heater to %s' % status.get(mode, "Unknown"))
    ...
    def do_get_mode(self):
        ...
        '''
        logging.debug(__name__ + ' : Get device mode')
        result = self._execute('X')
...
True
        ...
        if status.__contains__(mode):
            logging.debug(__name__ + ' : Setting device mode to %s' % status.get(mode, "Unknown"))
    ...
    def do_get_polarity(self):
        ...
        logging.debug(__name__ + ' : Get device polarity')
        result = self._execute('X')
    ...
    def do_set_polarity(self,mode):
        ...
        if status.__contains__(mode):
        	...
        	logging.info('set_polarity: Invalid mode inserted.')
